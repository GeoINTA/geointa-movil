...
angular.module('geointa.controllers', [])
    .controller('IndexController', ['$scope', '$rootScope','$routeParams', function ($scope, $rootScope,$routeParams) {
          ...
          $scope.appDescription = "Se trata de un desarrollo Web orientado para dispositivos móviles.\n El objetivo es que el usuario pueda relevar información proveniente de la IDE del INTA sin contar con conocimientos previos de SIG.";
     }]) 
